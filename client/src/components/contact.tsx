                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="relative group">
                    <Input
                      ...
                      className="bg-white/20 border-white/30 text-white h-14 rounded-2xl font-georgian text-lg focus:border-yellow-400 focus:ring-yellow-400/20 transition-all duration-300"
                      required
                    />
                  ...
                  <div className="relative group">
                    <Textarea
                      ...
                      onChange={handleChange}
                      className="bg-white/20 border-white/30 text-white resize-none rounded-2xl font-georgian text-lg focus:border-yellow-400 focus:ring-yellow-400/20 transition-all duration-300"
                      required
                    />
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-purple-500/20 to-cyan-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                  </div>
